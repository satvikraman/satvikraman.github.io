...
MBSs and CDOs are a product of Financial Engineering. MBS, are securities similar to bonds that are backed by a bundle of home loans. CDO are a financial product which is backed by a pool of loans and other assets. Want to read more, then click on [What are Mortgage Backed Securities (MBS) and Collateralized Debt Obligations (CDO)](./../../concepts/mortgage-backed-securities/index.qmd)
:::

::: {.callout-caution collapse="true"}
## What are Prime, Subprime and Alt-A loans?
Prime, Sub-Prime and Alt-A refers to the classification of a mortgage based on its risk profile. Relatively, Prime carries the least amount of risk, then comes Alt-A and then Sub-Prime. Want to read more, then click on [What are Prime, Subprime and Alt-A loans](./../../concepts/Prime-SubPrime-Alt-A/index.qmd)
:::
...
Leveraged position or financial leverage is the act of borrowing money to invest. Leverage helps boosts returns when the trade is favourable but can also increase losses if the trade is unfavourable. Want to read more, then click on [Financial Leverage](./../../concepts/financial-leverage//index.qmd)
:::
